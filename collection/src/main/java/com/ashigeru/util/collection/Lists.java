 ...
 */
package com.ashigeru.util.collection;
...
public class Lists {
     ...
     * @return 生成したリスト
     */
    public <E> List<E> create(E elem1, E elem2) {
        ArrayList<E> result = new ArrayList<E>();
        result.add(elem1);
        result.add(elem2);
        return result;
     ...
     * @return 生成したリスト
     */
    public <E> List<E> create(E elem1, E elem2, E elem3) {
        ArrayList<E> result = new ArrayList<E>();
        result.add(elem1);
        result.add(elem2);
        result.add(elem3);
     ...
     */
    public <E> List<E> create(E elem1, E elem2, E elem3, E elem4, E... rest) {
        if (rest == null) {
     ...
     */
    public <E> List<E> copy(Iterable<? extends E> iterable) {
        if (iterable == null) {
     ...
     * @throws IllegalArgumentException 引数に{@code null}が指定された場合
     */
    public <E> List<E> freeze(Iterable<? extends E> iterable) {
        if (iterable == null) {
            throw new IllegalArgumentException("iterable must not be null"); //$NON-NLS-1$
        }
     ...
     * @throws IllegalArgumentException 引数に{@code null}が指定された場合
     */
    public <E> List<E> freeze(E[] array) {
        if (array == null) {
            throw new IllegalArgumentException("array must not be null"); //$NON-NLS-1$
        }
        E[] copy = array.clone();
